...
function GreetingStack() {
	return (
		<Grid container spacing={4} direction='column' display='flex' justifyContent='space-between'>
...
function Greeting() {
	return <Typography component='h1' variant='h3' fontWeight='bold' textAlign='center'>Welcome to Dungeons & Dragons Online!</Typography>;
}
